...
@NamedQueries({
		...
		@NamedQuery(name = "negocio.empleados.objetonegocio.Empleado.findByidDepartamento", query = "select obj from Empleado obj where obj.idDepartamento = :idDepartamento") })
