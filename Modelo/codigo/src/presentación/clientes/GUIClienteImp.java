...
public class GUIClienteImp extends GUICliente {
	 ...
	 * @generated "UML a Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	private FrameModificaciónclientes frameModificación;

	/** 
	 * @return el frameModificación
	 * @generated "UML a Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	public FrameModificaciónclientes getFrameModificación() {
		// begin-user-code
	 ...
	 * @generated "UML a Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	public void setFrameModificación(FrameModificaciónclientes frameModificación) {
		// begin-user-code
	 ...
	 * @generated "UML a Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	private FrameConsultaMúltipleClientes frameConsultaMúltiple;

	/** 
	 * @return el frameConsultaMúltiple
	 * @generated "UML a Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	public FrameConsultaMúltipleClientes getFrameConsultaMúltiple() {
		// begin-user-code
	...
	public void setFrameConsultaMúltiple(
			FrameConsultaMúltipleClientes frameConsultaMúltiple) {
		// begin-user-code
